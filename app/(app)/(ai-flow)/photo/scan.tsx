...
export default function PhotoZoneQRScreen() {
  ...
  const handleQRScan = () => {
    router.push({
      pathname: '/(app)/(ai-flow)/photo/camera',
      params: {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          ...
          <Text style={styles.headerTitle}>{questName}</Text>
        </View>
        <Pressable onPress={() => router.back()}>
          <Svg width="15" height="15" viewBox="0 0 15 15" fill="none">
            <G clipPath="url(#clip0_6_16328)">
              <Path
                fillRule="evenodd"
                clipRule="evenodd"
      ...
      {/* Instructions Text */}
      <Text style={styles.instructionText}>Find QR Codes{'\n'}to open AR Camera</Text>

      {/* Base Map Image */}
      <View style={styles.mapContainer}>
        <Image source={Images.baseMap2} style={styles.mapImage} resizeMode="cover" />
      </View>
